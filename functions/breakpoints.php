    ...
    ?>
        <style>
            :root{
                ...
                /* shop */
                --padding--breadcrumb--shop:35px 0 32px;
                ...
                --width--tab-description:min(100%, 820px);
                    ...
                    --padding--related-products:42px 0 42px;
            ...
            @media(min-width:768px){
                :root{
                    ...
                    /* shop */
                    --padding--breadcrumb--shop:40px 0;
                    ...
                    --padding--tabs-panel:41px 0 53px;
                        ...
                        /* productos relacionados */
                        --padding--related-products:56px 0 56px;
                ...
                /* cabecera */
                    ...
                    /* carrito */
                    #main-header .mobile-header .header-content .attachment-list :is(.wishlist-wrapper, .cart-wrapper) .counter{font-size:16px; gap:3px;}
            ...
            @media(min-width:1024px){
                :root{
                    ...
                    /* shop */
                    --padding--breadcrumb--shop:56px 0;
